...
namespace FBXLoader
{
	...
	bool Functions::FBXLoadFile(std::vector<Vertex> * outVerts, std::vector<unsigned int> * outIndices, std::vector<DirectX::XMFLOAT4X4> *outBoneMats, const char * filePath)
	{
