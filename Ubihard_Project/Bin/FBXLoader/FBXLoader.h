...
namespace FBXLoader
{
	...
	public:
		...
		static FBXLOADER_API bool FBXExportToBinary(std::vector<Vertex> * outVerts, std::vector<unsigned int> * outIndices, const char * inFilePath, const char * outFilePath);
